...
<div style="margin-top: 40px;display: flex; flex-direction: row;justify-content: center; width: 100%; height: 50%; align-items: center;">
  <form  action="EditProduct" method="POST" style="margin-top: 60px;width: fit-content; margin: auto; display: flex; flex-direction: column; align-items: start; ">
    <h1>EDIT PRODUCT</h1>
    <label for="category" class="col-sm-2 col-form-label">Category</label>
    <input type="text" id="category" name="category">
    <label for="name" class="col-sm-2 col-form-label">Name</label>
    <input type="text" id="name" name="name">
    <label for="name" class="col-sm-2 col-form-label">New value</label>
    <input type="text" id="val" name="val">
    <select name="field">
      <option value = <%=DataBaseManager.parameter.NAME%>>Name</option>
      <option value = <%=DataBaseManager.parameter.CATEGORY%>>Category</option>
    </select>
